...
class User_lowongan extends CI_Controller 
{
	...
	public function hitungRekomendasi()
	{
            ...
            if($alternatif['tampil']->num_rows()) 
			{
				...
				$data_kriteria = $this->m_data->ambil_kriteria_id('alvin.oktav');
				
                if ($allCriteria->num_rows()) 
				{
				
                    // GET TOTAL RESPONDEN
                    $totalRespondent = $this->m_data->total_responden_id('alvin.oktav')->result();
