                  ...
                  <div class="col-lg-6">
                      <section class="panel">
						  ...
						  <form action="<?php echo base_url().'index.php/Edit_Category/ganti_nama_kategori';?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Category</label>
                                      <input type="text" class="form-control" style="border: 1px solid #CCC; margin: 10px 0px; padding: 10px; width:550px; height: auto; background-color: #FFFFFF; text-align: left;" name="judul_baru" placeholder="Title" >
                                  </div>
